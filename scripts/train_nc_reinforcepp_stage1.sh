...
SAVE_MODEL_NAME="${AGENTGL_NC_REINFORCEPP_STAGE1_SAVE_NAME:-agentgl_nc_reinforcepp_stage1}"
DATA_PATH="${AGENTGL_NC_REINFORCEPP_STAGE1_DATA_PATH:-${AGENTGL_NC_TRAIN_DIR}/ogbn-arxiv_stage1_2000.jsonl,${AGENTGL_NC_TRAIN_DIR}/ogbn-products_stage1_2000.jsonl}"
GRAPH_DATA_DIR="${AGENTGL_NC_GRAPH_DATA_DIR:-${AGENTGL_NODE_DATA_ROOT}/ogbn-arxiv,${AGENTGL_NODE_DATA_ROOT}/ogbn-products}"
PRETRAIN_PATH="${AGENTGL_NC_REINFORCEPP_STAGE1_MODEL:-${AGENTGL_BASE_MODEL_NC_REINFORCEPP_STAGE1}}"
...
cmd=(
  ...
  --save_steps "${AGENTGL_NC_STAGE1_SAVE_STEPS:-20}"
