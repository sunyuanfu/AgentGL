...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--node-data-root",
        type=str,
        default=os.environ.get("AGENTGL_NODE_DATA_ROOT", "node_data"),
        help="Root directory containing dataset artifacts",
    )
    parser.add_argument(
        "--edge-dir",
        type=str,
        default=os.environ.get("AGENTGL_EDGE_DATA_ROOT", "edge_indices"),
    ...
    parser.add_argument("--seed", type=int, required=True, help="Random seed for sampling. Choose and report your own seed.")
