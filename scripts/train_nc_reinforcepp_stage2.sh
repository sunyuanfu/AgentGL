...
SAVE_MODEL_NAME="${AGENTGL_NC_REINFORCEPP_STAGE2_SAVE_NAME:-agentgl_nc_reinforcepp_stage2}"
DATA_PATH="${AGENTGL_NC_REINFORCEPP_STAGE2_DATA_PATH:-${AGENTGL_NC_TRAIN_DIR}/ogbn-arxiv_stage2_1000.jsonl,${AGENTGL_NC_TRAIN_DIR}/ogbn-products_stage2_1000.jsonl}"
GRAPH_DATA_DIR="${AGENTGL_NC_GRAPH_DATA_DIR:-${AGENTGL_NODE_DATA_ROOT}/ogbn-arxiv,${AGENTGL_NODE_DATA_ROOT}/ogbn-products}"
PRETRAIN_PATH="${AGENTGL_NC_REINFORCEPP_STAGE2_MODEL:-${AGENTGL_OUTPUT_ROOT}/ckpts/agentgl_nc_reinforcepp_stage1}"
...
cmd=(
  ...
  --graph_topk_similar "${AGENTGL_GRAPH_TOPK_SIMILAR}"
  --graph_topk_one_hop "${AGENTGL_GRAPH_TOPK_ONE_HOP}"
  --graph_topk_two_hop "${AGENTGL_GRAPH_TOPK_TWO_HOP}"
  --graph_topk_pagerank "${AGENTGL_GRAPH_TOPK_PAGERANK}"
  --graph_reflect_after_docs
  --flash_attn
  --gradient_checkpointing
  --save_steps "${AGENTGL_NC_STAGE2_SAVE_STEPS:-10}"
