...
SAVE_MODEL_NAME="${AGENTGL_LP_REINFORCEPP_STAGE1_SAVE_NAME:-agentgl_lp_reinforcepp_stage1}"
DATA_PATH="${AGENTGL_LP_REINFORCEPP_STAGE1_DATA_PATH:-${AGENTGL_LP_STAGE_DIR}/ogbn-arxiv_stage1.jsonl,${AGENTGL_LP_STAGE_DIR}/ogbn-products_stage1.jsonl}"
GRAPH_DATA_DIR="${AGENTGL_LP_GRAPH_DATA_DIR:-${DATA_PATH}}"
PRETRAIN_PATH="${AGENTGL_LP_REINFORCEPP_STAGE1_MODEL:-${AGENTGL_BASE_MODEL_LP_REINFORCEPP_STAGE1}}"
...
cmd=(
  ...
  --lp_allowed_difficulties "${AGENTGL_LP_STAGE1_DIFFICULTIES:-easy,medium}"
  --ref_num_nodes 1
  ...
  --prompt_max_len 1024
  --generate_max_len "${AGENTGL_LP_STAGE1_MAX_LENGTH:-2000}"
  --zero_stage 2
  --bf16
  --load_checkpoint
