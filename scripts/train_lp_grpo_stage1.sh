...
SAVE_MODEL_NAME="${AGENTGL_LP_GRPO_STAGE1_SAVE_NAME:-agentgl_lp_grpo_stage1}"
DATA_PATH="${AGENTGL_LP_GRPO_STAGE1_DATA_PATH:-${AGENTGL_LP_STAGE_DIR}/ogbn-arxiv_stage1.jsonl,${AGENTGL_LP_STAGE_DIR}/ogbn-products_stage1.jsonl}"
GRAPH_DATA_DIR="${AGENTGL_LP_GRAPH_DATA_DIR:-${DATA_PATH}}"
PRETRAIN_PATH="${AGENTGL_LP_GRPO_STAGE1_MODEL:-${AGENTGL_BASE_MODEL_LP_GRPO_STAGE1}}"
