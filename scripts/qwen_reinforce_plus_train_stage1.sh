...
ARXIV_JSONL=${OUT_DIR}/ogbn-arxiv_stage1_2000.jsonl
PRODUCTS_JSONL=${OUT_DIR}/ogbn-products_stage1_2000.jsonl
...
TOKENIZER_PATH=/PATH/TO/WORKSPACE/Qwen3-4B
...
SAVE_MODEL_NAME=qwen_graph_rl_stage1_4_v14_4b
