...
STAGE1_ARXIV=${OUT_DIR}/ogbn-arxiv_stage1_rebalanced.jsonl
STAGE1_PRODUCTS=${OUT_DIR}/ogbn-products_stage1_rebalanced.jsonl
...
ARXIV_JSONL=${OUT_DIR}/ogbn-arxiv_stage2_rebalanced.jsonl
PRODUCTS_JSONL=${OUT_DIR}/ogbn-products_stage2_rebalanced.jsonl
...
TOKENIZER_PATH=/PATH/TO/WORKDIR/rag_rl/results/ckpts/qwen_graph_rl_stage1_3b_grpo
...
SAVE_MODEL_NAME=qwen_graph_rl_stage2_3b_grpo
GROUP_METHOD=normal
