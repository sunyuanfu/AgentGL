...
# Datasets and cached Stage1 paths
DATASETS="ogbn-arxiv,ogbn-products"
OUT_DIR=/PATH/TO/WORKSPACE/AgentGL/data/training_set
STAGE1_ARXIV=${OUT_DIR}/ogbn-arxiv_stage1_2000.jsonl
STAGE1_PRODUCTS=${OUT_DIR}/ogbn-products_stage1_2000.jsonl

# Regenerate Stage2 JSONLs with split-aware sampling (idempotent)
# python3 /PATH/TO/WORKSPACE/AgentGL/train/generate_datasets_from_splits.py \
#   --node-data-root ${NODE_DATA_ROOT} \
#   --datasets ${DATASETS} \
#   --mode stage2 \
#   --stage1-files ${STAGE1_ARXIV},${STAGE1_PRODUCTS} \
#   --eval-dir /PATH/TO/WORKSPACE/AgentGL/data/eval_set \
#   --output-dir ${OUT_DIR}

# Stage2 hard/medium training JSONLs
ARXIV_JSONL=${OUT_DIR}/ogbn-arxiv_stage2_1000.jsonl
PRODUCTS_JSONL=${OUT_DIR}/ogbn-products_stage2_1000.jsonl
...
TOKENIZER_PATH=/PATH/TO/WORKDIR/rag_rl/results/ckpts/qwen_graph_rl_stage1_4_v10_3b
...
SAVE_MODEL_NAME=qwen_graph_rl_stage2_4_v11_3b
