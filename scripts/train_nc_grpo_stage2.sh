...
SAVE_MODEL_NAME="${AGENTGL_NC_GRPO_STAGE2_SAVE_NAME:-agentgl_nc_grpo_stage2}"
DATA_PATH="${AGENTGL_NC_GRPO_STAGE2_DATA_PATH:-${AGENTGL_NC_TRAIN_DIR}/ogbn-arxiv_stage2_1000.jsonl,${AGENTGL_NC_TRAIN_DIR}/ogbn-products_stage2_1000.jsonl}"
GRAPH_DATA_DIR="${AGENTGL_NC_GRAPH_DATA_DIR:-${AGENTGL_NODE_DATA_ROOT}/ogbn-arxiv,${AGENTGL_NODE_DATA_ROOT}/ogbn-products}"
PRETRAIN_PATH="${AGENTGL_NC_GRPO_STAGE2_MODEL:-${AGENTGL_OUTPUT_ROOT}/ckpts/agentgl_nc_grpo_stage1}"
