...
SAVE_MODEL_NAME="${AGENTGL_LP_REINFORCEPP_STAGE2_SAVE_NAME:-agentgl_lp_reinforcepp_stage2}"
DATA_PATH="${AGENTGL_LP_REINFORCEPP_STAGE2_DATA_PATH:-${AGENTGL_LP_STAGE_DIR}/ogbn-arxiv_stage2.jsonl,${AGENTGL_LP_STAGE_DIR}/ogbn-products_stage2.jsonl}"
GRAPH_DATA_DIR="${AGENTGL_LP_GRAPH_DATA_DIR:-${DATA_PATH}}"
PRETRAIN_PATH="${AGENTGL_LP_REINFORCEPP_STAGE2_MODEL:-${AGENTGL_OUTPUT_ROOT}/ckpts/agentgl_lp_reinforcepp_stage1}"
